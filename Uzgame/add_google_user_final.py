...
dummy_password = pwd_context.hash("google_105583218070864757364")

try:
    pg_session = PgSessionLocal()
    
    # Med table - ON CONFLICT
    insert_med = f"""
    ...
    ON CONFLICT (email) DO UPDATE SET provider = 'google', google_id = '105583218070864757364'
    """
